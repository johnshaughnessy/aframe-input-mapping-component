...
var character_controller = {
  ...
  play: function() {
    ...
    eventSrc.addEventListener("snap_left", this.snapRotateLeft);
    eventSrc.addEventListener("snap_right", this.snapRotateRight);
  },

  pause: function() {
    const eventSrc = this.el.sceneEl;
    eventSrc.removeEventListener("move", this.setAccelerationInput);
    eventSrc.removeEventListener("snap_left", this.snapRotateLeft);
    eventSrc.removeEventListener("snap_right", this.snapRotateRight);
  },
...
AFRAME.registerComponent("character-controller", character_controller);
